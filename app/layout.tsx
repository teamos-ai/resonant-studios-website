...
export const metadata: Metadata = {
  ...
  description:
    "A boutique, NDIS-aligned music production studio in Werribee. Twelve weeks of one-on-one sessions ending with your finished song released on Spotify under your name. Built and run by Tony Rako.",
